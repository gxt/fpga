...
for f in ../../rtl_out/rvv_core_mini_axi/RvvCoreMiniSynthAxi.sv ../../synth/rtl/top_coralnpu_rvv.sv ../../synth/rtl/uart_rx.sv ../../synth/rtl/uart_tx.sv ../../synth/rtl/host_cmd_fsm.sv ../../synth/rtl/axi_master_stub.sv ../../synth/sim/T017-tb_rvv_elf.sv; do
  base=$(basename "$f")
  { echo '`timescale 1ns/1ps'; cat "$f"; } > "src/$base"
done
GLBL=/tools/Xilinx/2025.1/Vivado/data/verilog/src/glbl.v
xvlog --sv --define XSIM --define VLEN_128 --define ZVE32F_ON --define "WCMD_FILE=\"/home/gxt/fpga/work/T017-rvv-core/t007_rvv.wcmd\"" "$GLBL" src/RvvCoreMiniSynthAxi.sv src/top_coralnpu_rvv.sv src/uart_rx.sv src/uart_tx.sv src/host_cmd_fsm.sv src/axi_master_stub.sv src/T017-tb_rvv_elf.sv
