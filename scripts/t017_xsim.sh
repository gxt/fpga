...
xvlog --sv --define XSIM --define VLEN_128 --define "WCMD_FILE=\"/home/gxt/fpga/work/T017-rvv-core/t007_rvv.wcmd\"" "$GLBL" src/RvvCoreMiniAxi.sv src/top_coralnpu_rvv.sv src/uart_rx.sv src/uart_tx.sv src/host_cmd_fsm.sv src/axi_master_stub.sv src/T017-tb_rvv_elf.sv
