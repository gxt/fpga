...
# 编译 synth/rtl + rtl_out/core_mini_axi + synth/sim/T016-tb_uart_cont.sv → xsim
# =============================================================================
set -e
...
for f in ../../rtl_out/core_mini_axi/CoreMiniAxi.sv ../../synth/rtl/top_coralnpu.sv ../../synth/rtl/uart_rx.sv ../../synth/rtl/uart_tx.sv ../../synth/rtl/host_cmd_fsm.sv ../../synth/rtl/axi_master_stub.sv ../../synth/sim/T016-tb_uart_cont.sv; do
  base=$(basename "$f")
